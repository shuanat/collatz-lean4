...
lemma ap_structure_complete (_k_0 : ℕ) (_M_tilde_k0 : ℕ) (_t : ℕ) (_ht : 3 ≤ _t) : True := trivial

lemma touch_distribution_uniform (_k_0 : ℕ) (_M_tilde_k0 : ℕ) (_t : ℕ) (_ht : 3 ≤ _t) : True := trivial
